...
class Annotation:
    def __init__(self, text_database_path: str, clause_db_path: str,
                 sequence_db_path: str, log_file_path: str):
        annotation_service: AnnotationService = AnnotationService(text_database_path, clause_db_path, sequence_db_path)
